        ...
        public override void Effect(World current_world, Deity creator, int current_age)
        {
            ...
            while (not_found_valid_area)
            {
                ...
                if (location.AreaRegion.Landmass && neighbourAreaHasMainRace(location.Neighbours))
                {
                    ...
                    Organisation creator_worhip_order = new Organisation("Fire Dragons Creator Worshippers", creator, OrganisationType.ReligiousOrder, OrganisationPurpose.WorshipCreator);

                    Race fire_dragons = new Race("Fire Dragons", creator, location, creator_worhip_order);
                    ...
                    creator.CreatedRaces.Add(fire_dragons);
