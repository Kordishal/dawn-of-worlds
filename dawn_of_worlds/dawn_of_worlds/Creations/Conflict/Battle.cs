...
namespace dawn_of_worlds.Creations.Conflict
{
    class Battle : Creation
    {
        ...
        public void Fight()
        {
            int attacker_strenght = Main.MainLoop.RND.Next(2, 13) + AttackerArmy.ArmyStrenghtBonus;
            int defender_strenght = Main.MainLoop.RND.Next(2, 13) + AttackerArmy.ArmyStrenghtBonus;
